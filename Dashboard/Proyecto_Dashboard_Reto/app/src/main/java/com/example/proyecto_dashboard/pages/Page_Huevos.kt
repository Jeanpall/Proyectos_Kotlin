...
private val favoriteCollectionsData = listOf(
    Triple(R.drawable.hu_gallina, R.string.hu_huevos_gallina, R.string.hu_huevos_gallina_descripcion),
    Triple(R.drawable.hu_codorniz, R.string.hu_huevos_codorniz, R.string.hu_huevos_codorniz_descripcion),
    Triple(R.drawable.hu_avestruz, R.string.hu_huevos_avestruz, R.string.hu_huevos_avestruz_descripcion),
    Triple(R.drawable.hu_jumbo, R.string.hu_huevos_jumbo, R.string.hu_huevos_jumbo_descripcion),
).map { DrawableStringPairHuevos(it.first, it.second, it.third) }
