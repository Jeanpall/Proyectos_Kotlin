...
private fun Greetings(
    ...
    cardCollection: List<DrawableStringPairInicio> = listOf(
        Triple(R.drawable.in_campesino,R.string.dia_campesino,R.string.dia_campesino_descripcion),
        Triple(R.drawable.in_empresarial, R.string.feria_empresarial, R.string.feria_empresarial_descripcion),
        Triple(R.drawable.in_bicicleta, R.string.bicicleta, R.string.bicicleta_descripcion),
        Triple(R.drawable.in_empresarial, R.string.salud_oral, R.string.salud_oral_descripcion),
        Triple(R.drawable.in_bicicleta, R.string.practicas_laborales, R.string.practicas_laborales_descripcion),
