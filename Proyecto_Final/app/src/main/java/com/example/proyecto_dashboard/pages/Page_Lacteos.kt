...
fun Page_Lacteos(modifier: Modifier = Modifier) {
    ...
    val selectedItem = remember { mutableStateOf<DrawableStringPairLacteos?>(null) }
...
private val favoriteCollectionsData = listOf(
    DrawableStringPairLacteos(R.drawable.la_leche_vaca, R.string.la_leche_vaca, R.string.la_leche_vaca_descripcion, R.string.precio_leche_vaca, R.string.medida_leche_vaca),
    DrawableStringPairLacteos(R.drawable.la_leche_cabra, R.string.la_leche_cabra, R.string.la_leche_cabra_descripcion, R.string.precio_leche_cabra, R.string.medida_leche_cabra),
    DrawableStringPairLacteos(R.drawable.la_yogurt, R.string.la_yogurt, R.string.la_yogurt_descripcion, R.string.precio_yogurt, R.string.medida_yogurt),
    DrawableStringPairLacteos(R.drawable.la_queso, R.string.la_queso, R.string.la_queso_descripcion, R.string.precio_queso, R.string.medida_queso),
)
