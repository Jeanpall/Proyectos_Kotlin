...
import com.example.proyecto_dashboard.utils.Utils.EaseOutBounce
import com.example.proyecto_dashboard.utils.Utils.EaseOutQuart

/**
 * Además, el objeto Utils también define dos valores: [EaseOutBounce] y [EaseOutQuart].
 * Estos valores son objetos de tipo Easing que representan funciones de interpolación para animaciones.
 */
object Utils {
